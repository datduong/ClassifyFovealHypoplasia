...
SUFFIX = 'Img+Meta2+logMAR+FHScore+6F+driving'

LABELUP = 'A;C'

# METAFEAT = 'eye_position_od,eye_position_os,machine_type_z,machine_type_hb,age_taken,spherical_equivalent,nystagmus,dAniridia,dCHS,dErdheim Chester disease,dFH isolated,dHPS,dNanophthalmos,dOA,dOCA,dWaardenburg 2A,gGPR143,gHPS1,gMITF,gOCA2,gPAX6,gPRSS56,gSLC45A2,gTYR,gunknown,logMAR' 

METAFEAT = 'machine_type_z,machine_type_hb,age_taken,spherical_equivalent,nystagmus,logMAR'

# METAFEAT = 'machine_type_z,machine_type_hb,age_taken,spherical_equivalent,nystagmus,logMAR,FHScore'
      ...
      for schedulerscaler in [10]:
        for learn_rate in [0.00001]:  # 0.00001,0.00003  # we used this too, 0.0001
          for dropout in [0.2]: # 0.2
            ...
            # 
            time.sleep( 2 )
            os.system('sbatch --partition=gpu --time=04:00:00 --gres=gpu:p100:1 --mem=10g --cpus-per-task=8 ' + scriptname )
